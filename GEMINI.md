...
Create a curriculum for learning all 21 human amino acids, their relationships, and mRNA codons. Use tools described in https://github.com/chatelao/ai-tooling

Erstelle dazu von jeder Aminosäure ein 2D, Stäbchen- und Kugelmodell.
...
- The `ROADMAP.md` file is structured into several key sections:
  - **Progress Overview**: A table summarizing Phases, Descriptions, and Status (using ✅ for completed, 🏗️ for in-progress, ⏳ for planned).
