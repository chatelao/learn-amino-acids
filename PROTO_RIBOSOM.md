# Proto-Ribosome Theory & PTC Knowledge

This document provides a summary of the current research on the origin and evolution of the ribosome, specifically the "Proto-Ribosome" theory, and our current understanding of the Peptidyl Transferase Center (PTC).
...
*   **Ribozyme Nature:** The PTC is composed entirely of RNA. No protein residues are found within ~18 Å of the site of peptide bond formation, confirming that the ribosome is a ribozyme.
*   **Catalytic Mechanism:** The PTC does not use a traditional acid-base catalysis. Instead, it works through:
...
| Period | Milestone | Key Contributors |
| :--- | :--- | :--- |
| **1950s** | Discovery of the ribosome as the site of protein synthesis. | George Palade |
| **1960s** | Identification of the large subunit as the carrier of peptidyl transferase activity. | Various |
| **1980s** | Discovery of ribozymes; the "RNA World" hypothesis gains prominence. | Cech, Altman |
| **1992** | Evidence that the PTC is composed of RNA (the "Noller Experiment"). | Harry Noller |
| **2000** | First high-resolution crystal structures of the 50S and 30S subunits. | Steitz, Ramakrishnan, Yonath |
| **2004** | Identification of the symmetrical pocket and proposal of the Proto-Ribosome theory. | Ada Yonath et al. |
| **2009** | Nobel Prize in Chemistry for studies of the structure and function of the ribosome. | Ramakrishnan, Steitz, Yonath |
| **2014** | The "Accretion Model" of ribosome evolution; mapping the expansion of rRNA. | Loren Williams et al. |
| **2021** | Structural constraints of the PTC during early elongation are mapped in detail. | Jia et al. |

## References
*   **Agmon, I. et al. (2005).** On the structure and function of the ancient ribosome. *FEBS Letters*.
*   **Bokov, K., & Steinberg, S. V. (2009).** A hierarchical model for evolution of 23S ribosomal RNA. *Nature*.
